...
<body class="text-center" style="background-color: rgb(241,247,252);">
    <div class="text-center d-xl-flex justify-content-center align-items-center justify-content-xl-center align-items-xl-center register-photo" style="padding: 0px;margin-top: 11%;">
        <div class="d-flex form-container" style="background-color: rgba(255,255,255,0);">
            <div class="col-6 text-center" style="height: 400px;">
            ...
            <div class="col-6" style="background-color: #ffffff;padding: 15px;padding-right: 0px;padding-left: 15px;">
                <form method="post" style="padding: 0px;max-width: 100%;padding-top: 0px;padding-right: 0px;padding-bottom: 0px;padding-left: 15px;">
